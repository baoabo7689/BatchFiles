...
@set systemUnderTest=Alpha.Main
...
"%openCover%" -target:"%testRunner%" -targetargs:"/nologo %solutionFolder%\!testProject!\bin\Debug\!testProject!.dll /noshadow" -filter:"+[!systemUnderTest!]!systemUnderTest!*" -excludebyattribute:"System.CodeDom.Compiler.GeneratedCodeAttribute" -register:user -output:"!codeCoverageResult!"
